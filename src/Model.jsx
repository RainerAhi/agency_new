...
export default function Model({ ...props }) {
  const { nodes, materials } = useSpline('https://prod.spline.design/QVIH7Ivf5zMa9iqS/scene.splinecode')
  return (
    <>
      ...
      <group {...props} dispose={null}>
        <scene name="Scene">
          ...
          />
          <OrthographicCamera  name="1" makeDefault={true} far={100000} near={-50000} zoom={ 0.4 } />
